class Question {
  ...
  display() {
    this.title.html("My Gk quiz Game");
    ...
    this.option1.html("1: Harilal Jekisundas Kania ");
    this.option1.position(150, 100);
    this.option2.html("2: Rajendra Prasad");
    this.option2.position(150, 120);
    this.option3.html("3: Hon'ble Mr. Justice M. Patanjali Sastri ");
    this.option3.position(150, 140);
    this.option4.html("4: Hon'ble Mr. Justice Bijan Kumar Mukherjea");
